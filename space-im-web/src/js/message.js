...
function _encodeHeader(message, bb) {
  ...
  if ($magic !== undefined) {
    writeVarint32(bb, 8);
    writeVarint64(bb, intToLong($magic));
  }
  ...
  if ($cmdId !== undefined) {
    writeVarint32(bb, 16);
    writeVarint64(bb, intToLong($cmdId));
  }

  // optional int32 bodyLength = 3;
  let $bodyLength = message.bodyLength;
  if ($bodyLength !== undefined) {
    writeVarint32(bb, 24);
    writeVarint64(bb, intToLong($bodyLength));
  }
  ...
  let $objectType = message.objectType;
  if ($objectType !== undefined) {
    writeVarint32(bb, 40);
    writeVarint64(bb, intToLong($objectType));
  }

  // optional int32 clientType = 6;
  let $clientType = message.clientType;
  if ($clientType !== undefined) {
    writeVarint32(bb, 48);
    writeVarint64(bb, intToLong($clientType));
  }
}
...
function _decodeHeader(bb) {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional int32 magic = 1;
      case 1: {
        message.magic = readVarint32(bb);
        break;
      }

      // optional int32 cmdId = 2;
      case 2: {
        message.cmdId = readVarint32(bb);
        break;
      }

      // optional int32 bodyLength = 3;
      case 3: {
        message.bodyLength = readVarint32(bb);
        break;
      }
      ...
      // optional int32 objectType = 5;
      case 5: {
        message.objectType = readVarint32(bb);
        break;
      }

      // optional int32 clientType = 6;
      case 6: {
        message.clientType = readVarint32(bb);
        break;
      }
...
export function encodeBody(message) {
  let bb = popByteBuffer();
  _encodeBody(message, bb);
  return toUint8Array(bb);
}

function _encodeBody(message, bb) {
  ...
  if ($appId !== undefined) {
    writeVarint32(bb, 16);
    writeVarint64(bb, intToLong($appId));
  }
...
export function decodeBody(binary) {
  return _decodeBody(wrapByteBuffer(binary));
}

function _decodeBody(bb) {
  let message = {};
